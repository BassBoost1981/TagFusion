      ...
      return (
        <div className="h-full w-full flex items-center justify-center p-8">
          <div className="glass rounded-2xl p-8 max-w-lg text-center">
            ...
            {/* Title */}
            <h2 className="text-xl font-semibold text-slate-100 mb-3">Etwas ist schiefgelaufen</h2>

            {/* Description */}
            <p className="text-slate-400 mb-6 px-4">
              Ein unerwarteter Fehler ist aufgetreten. Dies kann an einer beschädigten Bilddatei oder einem Problem mit
              der Verbindung zum System liegen.
            </p>
